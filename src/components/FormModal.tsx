...
const FORM_MAP: Record<TableName, any> = {
  penyuluh: NextDynamic(() => import("./forms/PenyuluhForm"), { ssr: false }),
  kelompoktani: NextDynamic(() => import("./forms/KelompokTaniForm"), { ssr: false }),
  kiospertanian: NextDynamic(() => import("./forms/KiosPertanianForm"), { ssr: false }),
  kegiatan: NextDynamic(() => import("./forms/KegiatanForm"), { ssr: false }),
  materi: NextDynamic(() => import("./forms/MateriForm"), { ssr: false }),
  dokumentasiacara: NextDynamic(() => import("./forms/DokumentasiAcaraForm"), { ssr: false }),
  pengumuman: NextDynamic(() => import("./forms/PengumumanForm"), { ssr: false }),
  desabinaan: NextDynamic(() => import("./forms/DesaBinaanForm"), { ssr: false }),
};
